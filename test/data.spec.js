...
const {
  convertToAbsolutePath, readExtFile, readMarkdownFile, getLinks,
  validateLink,
  readDirectory,
} = require('../data');
...
describe('convertToAbsolutePath', () => {
  it('should reject promise if path does not exist', () => convertToAbsolutePath('./esta/ruta/noexiste.md').catch((err) => {
    expect(err).toBe('No existe la ruta');
  }));
  it('should return an absolut path', () => convertToAbsolutePath('README.md').then((result) => {
...
describe('readExtFile', () => {
  it('shoud return true for files whit valid extention', () => readExtFile('/home/andrea/Documentos/Bootcamp Laboratoria/DEV009-md-links/test_files/file1.text').then((result) => {
    expect(result).toBe(true);
  }));

  it('shoud return false for files whit not vald extention', () => readExtFile('/home/andrea/Documentos/Bootcamp Laboratoria/DEV009-md-links/index.js').then((err) => {
    expect(err).toBe(false);
  }));
});

describe('readMarkdownFile', () => {
  it('should return files content correctly', () => readMarkdownFile('/home/andrea/Documentos/Bootcamp Laboratoria/DEV009-md-links/test_files/file1.text').then(
    (result) => {
...
describe('readDirectory', () => {
  it('should return an object with the paths of files md, no md and directories in to directory', () => (readDirectory('./test_files')).then((result) => {
